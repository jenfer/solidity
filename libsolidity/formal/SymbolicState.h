...
public:
	...
	smtutil::SortPointer sort() const { return m_tuple->sort(); }
...
public:
	...
	smtutil::SortPointer errorFlagSort() const { return m_error.sort(); }
	//@}
	...
	smtutil::SortPointer thisAddressSort() const { return m_thisAddress.sort(); }
	//@}
	...
	smtutil::SortPointer stateSort() const { return m_state.sort(); }
	...
	smtutil::SortPointer txSort() const { return m_tx.sort(); }
